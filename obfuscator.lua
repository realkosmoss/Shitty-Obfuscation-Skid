...
function obfuscate(source,VarName,WaterMark)
        ...
        if typeof(WaterMark) == "string" and WaterMark ~= nil then
            WM = "    "..tostring(WaterMark).." | Secure by Kosmos"
        else
            WM = "    ".."WaterMark".." | Secure by Kosmos"
        end
        ...
        local add_binary = function(number, s)
            ...
            local topic = {
                ...
                "Kosmos",
                "CumSockOnTOP!",
                "KosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmosKosmos",
